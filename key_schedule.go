...
// expectedServerKeyShareLen returns the wire length of a TLS 1.3 server key
// share for id. It is used to validate target ServerHello messages before their
// key share is replaced by the REALITY handshake.
func expectedServerKeyShareLen(id CurveID) (int, bool) {
	switch id {
	case X25519:
		return 32, true
	case CurveP256:
	...
	case CurveP521:
		return 133, true
	case X25519MLKEM768:
		return 32 + mlkem.CiphertextSize768, true
	case SecP256r1MLKEM768:
		return 65 + mlkem.CiphertextSize768, true
	case SecP384r1MLKEM1024:
		return 97 + mlkem.CiphertextSize1024, true
	case MLKEM1024:
		return mlkem.CiphertextSize1024, true
	default:
		return 0, false
	}
}
